from faers_transforms import demo_transforms
import pendulum
import pandas as pd
...
demo_pedi_raw = demo_transforms.pediRaw(raw_df_filt)
...
demo_pedi_raw = demo_transforms.checkAges01(demo_pedi_raw)
...
demo_pedi_raw = demo_transforms.checkAges02(demo_pedi_raw)
...
demo_pedi_raw_1 = demo_transforms.ageYrStandard(demo_pedi_raw)
...
demo_pedi_raw_2 = demo_transforms.ageBinning(demo_pedi_raw)
...
demo_pedi_raw_2_copy = demo_transforms.rmNA_VALbins(demo_pedi_raw_2_copy)
...
demo_pedi_raw_2_copy = demo_transforms.rmNA_VALbins_2(demo_pedi_raw_2_copy)
...
demo_pedi_raw_3 = demo_transforms.normalizeAges(demo_pedi_raw_2_copy)
...
demo_pedi_raw_4 = demo_transforms.dropMissingSex(demo_pedi_raw_3)
...
demo_pedi_raw_5 = demo_transforms.getOriginCountry(demo_pedi_raw_4)
...
demo_pedi_raw_6 = demo_transforms.rmMissingOrigin(demo_pedi_raw_5)
...
demo_pedi_raw_7 = demo_transforms.convLbsToKg(demo_pedi_raw_6)
...
demo_pedi_raw_8 = demo_transforms.wtCheck01(demo_pedi_raw_7)
...
demo_pedi_raw_9 = demo_transforms.findWtOutliers(demo_pedi_raw_8)
...
demo_pedi_raw_10 = demo_transforms.rmWtOutliers(demo_pedi_raw_9)
...
demo_pedi_transformed = demo_transforms.rmWtOutliers(demo_pedi_raw_10)
...
export_to_csv = demo_transforms.exportCSV(demo_pedi_transformed, "Out_Path")
